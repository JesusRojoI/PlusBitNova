...
const templates = {
  ...
  // 📋 Notificación al administrador (nuevo pago)
  ...
  // 📋 Cotización - Confirmación al cliente (NUEVO)
  ...
  // 📋 Cotización - Notificación al administrador (NUEVO)
...
// ============================================
// 2. FUNCIÓN PRINCIPAL PARA ENVIAR CORREOS
// ============================================
...
// ============================================
// 3. FUNCIONES ESPECÍFICAS PARA CADA CASO
// ============================================
...
// 📋 Envío de cotización (cliente + admin)
